...
function ManageProject() {
    const { manageProjectData, loading, error, setManageProjectData } = useFetchManageProject();
    ...
    const handleDelete = () => {
         ...
         axiosClient.delete(`/manage_project/delete/${selectedProject[0]}`).then(data => {
            setManageProjectData(prevDatas => prevDatas.filter(ManageProjects => ManageProjects[0] !== selectedProject[0]));
